...
namespace Ultima
{
    ...
    public static class Client
    {
        ...
        public static string GetFilePath(string file)
        {
            ...
            {
                string path = Path.Combine(dirs[i], file);
        ...
        private static List<string> LoadDirectories()
        {
            ...
            {
                string exePath = IntPtr.Size == 8 ? GetExePath(@"Wow6432Node\" + knownRegkeys[i]) : GetExePath(knownRegkeys[i]);
